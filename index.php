            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb_70">
                        ...
                        <p>Vacation in a beautiful city with friends or maybe a new acquaintance?</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        ...
                        <div class="content">
                            <p class="d-flex align-items-center">Jogja<a href="paketjogja.php">Detail</a> </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        ...
                        <div class="content">
                            <p class="d-flex align-items-center">Pacitan<a href="paketpacitan.php">Detail</a> </p>   
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        ...
                        <div class="content">
                            <p class="d-flex align-items-center">Malang<a href="paketmalang.php">Detail</a></p>   
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb_70">
                        ...
                        <p>vacation packages with a pair of happy hearts is beautiful isn't it?</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            ...
                            <a class="prise">IDR 600K</a>
                        </div>
                        <div class="place_info">
                            <a href="gunung_kidul.php"><h3>Gunung Kidul Beach</h3></a>
                            <p>Jogja</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        ...
                        <div class="place_info">
                            <a href="jogja.php"><h3>Jogja Town</h3></a>
                            <p>Jogja</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            ...
                            <a class="prise">IDR 900K</a>
                        </div>
                        <div class="place_info">
                            <a href="pacitan.php"><h3>Pacitan Beach</h3></a>
                            <p>Pacitan</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        ...
                        <div class="place_info">
                            <a href="maron.php"><h3>Maron River</h3></a>
                            <p>Pacitan</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            ...
                            <a class="prise">IDR 1400K</a>
                        </div>
                        <div class="place_info">
                            <a href="batu.php"><h3>Batu Village</h3></a>
                            <p>Malang</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        ...
                        <div class="place_info">
                            <a href="bromo.php"><h3>Bromo</h3></a>
                            <p>Malang</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-12">
                    <div class="video_wrap text-center">
                        ...
                        <div class="video_icon">
                            <a class="popup-video video_play_button" href="https://www.youtube.com/watch?v=kiHSKWIUP40">
