                ...
                <div class="col-lg-8 col-md-9">
                    <div class="destination_info">
                        ...
                        <div class="single_destination">
                            <h4>Ngerenehan Beach</h4>
                            <img src="img/destination/des1.png"/>
                            <p>Ngerenehan Beach is actually a bay flanked by 2 cliffs. The water is clear and white sand typical of Gunung Kidul beach. On the beach lined blue fishing boats matching the color of the water. On this beach the fishermen also sell their catch fish. You can also enjoy fresh seafood dishes because they have just been caught. Facilities at Ngerenehan beach include a full bathroom, toilet, mosaics, and a parking lot. The road to here has been paved smoothly so that it is comfortable during the trip. Curious? Go straight to Kanigoro Village, Saptosari District about 30 km south of Wonosari.</p>
                        </div>
                        <div class="single_destination">
                            <h4>Indrayanti Beach</h4>
                            <img src="img/destination/des2.png"/>
                            <p>Indrayanti Beach is one of the beach resorts in Jogja that is often recommended by tourists. The name of the beach Indrayanti itself is well known among tourists both local and foreign. Just like a typical south coast in the South Mountain region, the scenery here is no less beautiful. The beach is wide enough, fine sand, and clean blue sea. If you feel bored in Malioboro, this place can be a destination.</p>
                        </div>
                        <div class="single_destination">
                            <h4>Timang Beach</h4>
                            <img src="img/destination/des3.png"/>
                            <p>Timang Beach is a tourist attraction in the form of a beach, which is the area that forms the boundary between the sea and land, which is located in Gunungkidul Regency, Yogyakarta Special Region. Timang Beach is one of the beaches in Yogyakarta whose white sand. Timang Beach is located between Siung Beach and Sundak Gunungkidul Beach. Access to this beach is quite difficult, there are still many roads that have not been paved because the location of this beach is quite remote. The uniqueness of this beach is that there is an island which is a habitat for sea lobster across the coast.</p>
                        </div>
                    </div>
                </div>
            </div>
