            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        ...
                        <div class="place_info">
                            <a href="paketjogja_cust.php"><h3>Gunung Kidul Beach</h3></a>
                            <p>Jogja</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        ...
                        <div class="place_info">
                            <a href="paketjogja_cust.php"><h3>Jogja Town</h3></a>
                            <p>Jogja</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        ...
                        <div class="place_info">
                            <a href="paketpacitan_cust.php"><h3>Pacitan Beach</h3></a>
                            <p>Pacitan</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        ...
                        <div class="place_info">
                            <a href="paketpacitan_cust.php"><h3>Maron River</h3></a>
                            <p>Pacitan</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        ...
                        <div class="place_info">
                            <a href="paketmalang_cust.php"><h3>Batu Village</h3></a>
                            <p>Malang</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        ...
                        <div class="place_info">
                            <a href="paketmalang_cust.php"><h3>Bromo</h3></a>
                            <p>Malang</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
