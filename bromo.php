                ...
                <div class="col-lg-8 col-md-9">
                    <div class="destination_info">
                        ...
                        <div class="single_destination">
                            <h4>Peak View</h4>
                            <img src="img/destination/des13.png"/>
                            <p>the best location to watch the sun rise. This location is the highest among the other hills. Here you can immediately witness the beauty of the sunrise in the early morning with the beauty of the valley that is still covered in fog. To be able to reach hill climb 1, visitors can use vehicles such as jeeps and motorbikes. But for higher security, you should avoid using an automatic motorcycle because the terrain is quite heavy.</p>
                        </div>
                        <div class="single_destination">
                            <h4>Pasir Berbisik</h4>
                            <img src="img/destination/des14.png"/>
                            <p>Before reaching the crater of Mount Bromo, you will be greeted with a wide expanse of sand. This stretch of sand is named as whispering sand. The area is quite wide, visitors can easily take the best spots for photos. In addition, in this sand you can also enjoy other activities, such as riding a trilight motorcycle, riding a horse, and much more. Its location is to the east of the peak of Bromo.</p>
                        </div>
                        <div class="single_destination">
                            <h4>teletubbies Hills</h4>
                            <img src="img/destination/des15.png"/>
                            <p>The name of the Bromo teletubbies hill may be familiar to you. Even Bromo attractions are a favorite place for tourists. Besides being able to enjoy the beauty of Mount Bromo with a row of green hills. this area is also the best photo spot. The hill is filled with green grass which is very beautiful. Even the grass here is so awake that it looks so neat. So, when visiting the Bromo Tengger area, then don't miss to visit here.</p>
                        </div>
                    </div>
                </div>
            </div>
